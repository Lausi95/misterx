...
class TeamServiceTest {
    ...
    inner class GetMyTeam {
        ...
        fun `returns the team when no member id is supplied`() {
            ...
            val result = service.getMyTeam(TeamUseCase.GetMyTeamQuery(gameId, teamId, null), tenant)
        ...
        fun `throws when the team does not exist`() {
            ...
            assertThatThrownBy {
                service.getMyTeam(TeamUseCase.GetMyTeamQuery(gameId, teamId, null), tenant)
        ...
        fun `returns the team when the member exists and belongs to this team and game`() {
            ...
            val result = service.getMyTeam(TeamUseCase.GetMyTeamQuery(gameId, teamId, memberId), tenant)
        ...
        fun `throws when the supplied member does not exist`() {
            ...
            assertThatThrownBy {
                service.getMyTeam(TeamUseCase.GetMyTeamQuery(gameId, teamId, memberId), tenant)
