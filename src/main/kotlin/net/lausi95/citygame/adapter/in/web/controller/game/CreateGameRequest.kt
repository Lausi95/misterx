...
data class CreateGameRequest(
    ...
    @Schema(description = "Title of the game", required = true)
    @JsonProperty("title")
    @NotEmpty(message = "'title' cannot be null or empty")
    var title: String?,

    @Schema(description = "Start date of the game", required = true)
    @JsonProperty("startTime")
    @NotNull
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
    var startTime: OffsetDateTime?,

    @Schema(description = "End date of the game", required = true)
    @JsonProperty("endTime")
    @NotNull
    @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME)
    var endTime: OffsetDateTime?,

    @Schema(description = "Map of the game", required = true)
    @JsonProperty("map")
    @NotNull
    var map: MapDto?
) {
